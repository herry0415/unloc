...
class RobotCarDataset:
    ...
    def __init__(self, dataset_root: str, traversals: List[str], split: str, min_displacemenet: float = 0.2,
        ...
        print(len(self.radar_valid_ts))
        assert len(self.radar_valid_ts) == len(self.radar_scan_positions)
        print(len(self.radar_scan_positions),"radar_scan_positions")
        ...
        self.kdtree1 = KDTree(self.radar_scan_positions)
        distance, index = self.kdtree1.query(self.lidar_scan_positions, 2)

        # print(distance)
        # print((index))

        # print(self.kdtree.get_arrays())
...
if __name__ == '__main__':
    ...
    ds = RobotCarDataset(dataset_root='/media/ibrahim/21b7344f-7f8b-47fb-8de7-5199b164b720/RoboDataset', split='train', traversals=sequences,radar_subfolder='radar')
    # for i in ds:
    #     print(i)
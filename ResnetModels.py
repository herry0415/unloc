...
from imageslot import SlotAttentionAutoEncoder
...
class Imageloc(nn.Module):
    ...
    def forward(self,x):
        x = self.resnet(x)
        # print(x.shape, "x resnet")
        x =self.slotatten(x)
        # print(x.shape, "x slotatten")



        return x

class Radarloc(nn.Module):
    """Slot Attention-based auto-encoder for object discovery."""

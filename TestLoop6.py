...
writepath = "/home/ibrahim/Desktop/run6"
import warnings
...
def main(args):
    ...
    with torch.no_grad():
        ...
        for i_iter_val, data in enumerate(val_dataset_loader):
            ...
            t1 = (t_loss(trans1, Transgt)-4)
            r2 = r_loss(rot2, Rotgt)
            t2 = (t_loss(trans2, Transgt)-4)
            #
            ...
            t3 = (t_loss(trans3, Transgt)-6)
            r4 = r_loss(rot4, Rotgt)
            t4 = (t_loss(trans4, Transgt)-4)
            r5 = r_loss(rot5, Rotgt)
            t5 = (t_loss(trans5, Transgt)-5)
